  ...
  return (
    <footer>
        <div className="fbox footerinfo">
            <h1>ProjectTree</h1>
            <h4>ProjectTree is an open source web app that enables users to freely publish their projects and create user profiles within the platform</h4>
            <div className="social">
            <a href="https://www.instagram.com/bishal_de/" target="_blank">
